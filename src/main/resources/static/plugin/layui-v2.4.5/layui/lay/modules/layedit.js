...
function js_beautify(t, e, i, n) {
    ...
    function p() {
        ...
        var n = 1 === t;
        if (f(e, k)) {
            if (C < m.length) for (; f(m.charAt(C), k) && (e += m.charAt(C), (C += 1) !== m.length);) ;
            if (C !== m.length && e.match(/^[0-9]+[Ee]$/) && "-" === m.charAt(C)) {
                C += 1;
                return e += "-" + p(C)[0], [e, "TK_WORD"]
            }
        ...
        if ("/" === e) {
            var l = "";
            if ("*" === m.charAt(C)) {
                if ((C += 1) < m.length) for (; ("*" !== m.charAt(C) || !m.charAt(C + 1) || "/" !== m.charAt(C + 1)) && C < m.length && (l += m.charAt(C), !((C += 1) >= m.length));) ;
                return C += 2, ["/*" + l + "*/", "TK_BLOCK_COMMENT"]
            }
            if ("/" === m.charAt(C)) {
                for (l = e; "\r" !== m.charAt(C) && "\n" !== m.charAt(C) && (l += m.charAt(C), !((C += 1) >= m.length));) ;
        ...
        if ("'" === e || '"' === e || "/" === e && ("TK_WORD" === g && "return" === v || "TK_START_EXPR" === g || "TK_END_BLOCK" === g || "TK_OPERATOR" === g || "TK_EOF" === g || "TK_END_COMMAND" === g)) {
            var o = e, s = !1;
            if (e = "", C < m.length) for (; (s || m.charAt(C) !== o) && (e += m.charAt(C), s = !s && "\\" === m.charAt(C), !((C += 1) >= m.length));) ;
    ...
    for (m = t, x = "", g = "TK_START_EXPR", v = "", h = [], O = !1, L = !1, z = !1, E = "\n\r\t ".split(""), k = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split(""), w = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |=".split(" "), A = "continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(","), b = "BLOCK", _ = [b], n = n || 0, C = 0, N = !1; ;) {
        ...
        switch (K) {
            ...
            case "TK_WORD":
                ...
                S = "NONE", "TK_END_BLOCK" === g ? f(y.toLowerCase(), ["else", "catch", "finally"]) ? (S = "SPACE", o()) : S = "NEWLINE" : "TK_END_COMMAND" !== g || "BLOCK" !== b && "DO_BLOCK" !== b ? "TK_END_COMMAND" === g && "EXPRESSION" === b ? S = "SPACE" : "TK_WORD" === g ? S = "SPACE" : "TK_START_BLOCK" === g ? S = "NEWLINE" : "TK_END_EXPR" === g && (o(), S = "NEWLINE") : S = "NEWLINE", "TK_END_BLOCK" !== g && f(y.toLowerCase(), ["else", "catch", "finally"]) ? a() : f(y, A) || "NEWLINE" === S ? "else" === v ? o() : ("TK_START_EXPR" !== g && "=" !== v || "function" !== y) && ("TK_WORD" !== g || "return" !== v && "throw" !== v ? "TK_END_EXPR" !== g ? "TK_START_EXPR" === g && "var" === y || ":" === v || ("if" === y && "TK_WORD" === g && "else" === x ? o() : a()) : f(y, A) && ")" !== v && a() : o()) : "SPACE" === S && o(), s(), x = y, "var" === y && (L = !0, z = !1);
                break;
            case "TK_END_COMMAND":
                s(), L = !1;
                break;
            ...
            case "TK_OPERATOR":
                ...
                "--" === y || "++" === y ? ";" === v ? (R = !0, P = !1) : (R = !1, P = !1) : "!" === y && "TK_START_EXPR" === g ? (R = !1, P = !1) : "TK_OPERATOR" === g ? (R = !1, P = !1) : "TK_END_EXPR" === g ? (R = !0, P = !0) : "." === y ? (R = !1, P = !1) : ":" === y && (R = !!v.match(/^\d+$/)), R && o(), s(), P && o();
                break;
...
layui.define(["layer", "form", "code"], function (t) {
    ...
    var d = function (t, e, n) {
        ...
        d.on("keydown", function (t) {
            var e = t.keyCode;
            if (13 === e) {
                var i = p(s), r = m(i), c = r.parentNode;
                if ("pre" === c.tagName.toLowerCase()) {
                    if (t.shiftKey) return;
                    return n.msg("请暂时用shift+enter"), !1
                }
                "body" === c.tagName.toLowerCase() && s.execCommand("formatBlock", !1, "<p>"), setTimeout(function () {
                    s.execCommand("formatBlock", !1, "<p>")
                }, 10)
            }
            if (8 === e) {
                var i = p(s), r = m(i);
                "<hr>" == r.innerHTML && "body" == r.tagName.toLowerCase() && (i.selectNode(r.childNodes[0]), i.deleteContents())
            }
            setTimeout(function () {
                var t = d.html();
                8 == a.ie && (t = t.replace(/<.+>/g, function (t) {
                    return t.toLowerCase()
                })), o.autoSync && (l.value = t), o.onchange(t)
            }, 1)
            ...
            if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items) {
                for (var a = 0, s = e.originalEvent.clipboardData.items.length; a < s; a++) {
                    var r = e.originalEvent.clipboardData.items[a];
                    if ("file" === r.kind) {
                        var c = r.getAsFile(), u = new FormData;
                        u.append("file", c);
                        var p = o.uploadImage.url;
                        i.ajax({
                            type: "POST",
                            url: p,
                            data: u,
                            ...
                            success: function (e) {
                                if (0 == e.code || 2 == e.code) {
                                    var i = t.document.getSelection().getRangeAt(0), n = document.createElement("img");
                                    n.src = e.data.src;
                                    var l = document.createElement("p");
                                    l.appendChild(n), i.insertNode(l)
                                }
                            },
                            error: function (t) {
                                n.msg("上传服务器出错")
        ...
        var a = t.document, s = i(a.body), d = {
            link: function (e) {
                ...
                layui.use("upload", function (o) {
                    ...
                    "" == d.url && n.msg("上传接口配置错误！"), o.render({
                        ...
                        acceptMime: d.acceptMime || "image/*",
                        exts: d.exts || "jpg|png|gif|bmp|jpeg",
                        size: d.size || 10240,
                ...
                n.open({
                    ...
                    yes: function (i, l) {
                        var a = "";
                        "" != l.find('input[name="imgWidth"]').val() && (a += "width:" + l.find('input[name="imgWidth"]').val() + "px;"), "" != l.find('input[name="imgHeight"]').val() && (a += "height:" + l.find('input[name="imgHeight"]').val() + "px;"), 0 === l.find("#imgsPrev").find("img").length ? n.msg("请选择要插入的图片") : ("" != a && (a = 'style="' + a + '"'), h.call(t, "p", {text: l.find("#imgsPrev").html().replace(new RegExp(/(style="max-width:70px;margin:2px")/g), a)}, e), n.close(i))
                    },
                    btn2: function (t, e) {
                    ...
                    yes: function (i, o) {
                        ...
                        if ("" == s.val()) n.msg("请选择一个视频或输入视频地址"); else {
                            var c = '&nbsp;<video src="' + s.val() + '" poster="' + d.val() + '" ' + l.videoAttr + ' controls="controls" >您的浏览器不支持video播放</video>&nbsp;',
                                u = "";
                            a.video.title.length > 0 && r.length > 0 && (u = r[0].options[r[0].selectedIndex].value), h.call(t, "div", {
                                text: c,
                                class: u
                            }, e), n.close(i)
                        }
                    ...
                    success: function (t, e) {
                        layui.use("upload", function (e) {
                            var i, o = t.find('input[name="video"]'), s = t.find('input[name="cover"]'),
                                e = layui.upload, d = l.uploadImage || {};
                            "" == d.url && n.msg("图片上传接口配置错误！");
                            var r = l.uploadVideo || {};
                            "" == r.url && n.msg("视频上传接口配置错误！"), e.render({
                                elem: "#LayEdit_InsertImage",
                                url: d.url,
                                method: d.method,
                                data: d.data,
                                ...
                                headers: r.headers,
                                field: r.field,
                                accept: r.accept || "video",
                                acceptMime: r.acceptMime || "video/*",
                                exts: r.exts || "mp4|flv|avi|rm|rmvb",
                                size: r.size || 20480,
                                before: function (t) {
                                    i = n.msg("文件上传中,请稍等哦", {icon: 16, shade: .3, time: 0})
                                },
                ...
                n.open({
                    ...
                    success: function (t, e) {
                        layui.use("upload", function () {
                            var e = layui.upload, a = l.uploadFiles || {};
                            "" == a.url && n.msg("上传接口配置错误！");
                            var o = [];
                            e.render({
                                ...
                                field: a.field,
                                method: a.type,
                                accept: a.accept || "file",
                                acceptMime: a.acceptMime || "file/*",
                                exts: a.exts,
                                size: a.size || 30720,
                                multiple: !0,
                                before: function (t) {
                                ...
                                error: function (t, e) {
                                    ...
                                    0 == e.code ? (e.data = e.data || {}, i('#filesPrev a[data-index="' + o + '"]').attr("href", e.data.src), a.done(e)) : 2 == e.code ? (n.msg(e.msg || "上传失败"), e.data = e.data || {}, i('#filesPrev a[data-index="' + o + '"]').attr("href", e.data.src), a.done(e)) : n.msg(e.msg || "上传失败"), t.find("#filesPrev a").on("click", function () {
                ...
                var a = this.parentElement.nextElementSibling.firstElementChild.contentDocument.body.innerHTML;
                n.open({
                    type: 1, id: "layui-kz-preview", title: "预览", shade: .05, maxmin: !0, full: function (t) {
                        ...
                        return /mobile/i.test(navigator.userAgent) || i(window).width() <= 485 ? ["90%"] : ["600px"]
                    }(), offset: function () {
                        return /mobile/i.test(navigator.userAgent) ? "auto" : "100px"
                    }(), content: e.join("") + a, success: function (t, e) {
                        n.full(e), n.setTop(t)
                    }
                })
            ...
            if (!e.hasClass(o)) {
                ...
                l ? (/justifyLeft|justifyCenter|justifyRight/.test(l) && "BODY" === u.parentNode.tagName && a.execCommand("formatBlock", !1, "<p>"), a.execCommand(l), setTimeout(function () {
                    s.focus()
                }, 10)) : d[n] && d[n].call(this, c, a), y.call(t, r, e)
            }
        }, u = /image/;
        r.find(">i").on("mousedown", function () {
            ...
            y.call(t, r), n.close(T.index), n.close(_.index), n.close(E.index)
        });
                    ...
                    case "IMG":
                        f = n.open({
                            ...
                            yes: function (e, i) {
                                ...
                                "" == l ? n.msg("请选择一张图片或输入图片地址") : (t.target.src = l, t.target.alt = i.find('input[name="altStr"]').val(), t.target.style.width = "" != a ? a + "px" : "", t.target.style.height = "" != o ? o + "px" : "", n.close(e))
                            },
                            btn2: function (t, e) {
                            },
                            btn3: function (e, a) {
                        ...
                        s.video.title.length > 0 && (d = AddCustomThemes(s.video.title, s.video.content, s.video.preview)), f = n.open({
                            ...
                            success: function (t, e) {
                                layui.use("upload", function (e) {
                                    ...
                                    "" == d.url && n.msg("图片上传接口配置错误！"), "" == r.url && n.msg("视频上传接口配置错误！"), e.render({
                                        elem: "#LayEdit_InsertImage",
                                        url: d.url,
                                        method: d.method,
                                        data: d.data,
                            ...
                            success: function (e, s) {
                                ...
                                e.find(".layui-btn-primary").on("click", function () {
                                    ...
                                    "BODY" == a.tagName ? n.msg("不能再删除了") : "VIDEO" == a.tagName ? "" != d.url ? i.post(d.url, {
                                        ...
                                        o.remove(), d.done(t)
                                    }) : o.remove() : "IMG" == a.tagName && "" != d.url ? i.post(d.url, {para: t.target.src}, function (t) {
                                        a.remove(), d.done(t)
                                    }) : a.remove(), n.close(s)
                                })
                            }
